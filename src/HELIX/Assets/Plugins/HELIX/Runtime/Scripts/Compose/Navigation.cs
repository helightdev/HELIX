...
using VisualElementExtensions = HELIX.Extensions.VisualElementExtensions;
...
namespace HELIX.Compose {
    ...
    public partial class NavigationHostComposable{
      ...
      protected override void OnRecompose(ref Composition cx) {
        ...
        if (_controller.Count == 0 && Props.InitialRoute != null) {
          _controller.Push(
            (NavigationRouteBase)Props.InitialRoute,
      ...
      private void HandleChanged(NavigationChange change) {
        if (Node != null) RecompositionExtensions.MarkDirty(Node);
      }
  ...
  public static partial class NavigationPageDefinition {
    ...
    public partial class NavigationPageComposable {
      ...
      protected override void OnRecompose(ref Composition cx) {
        VisualElementExtensions.Stretched<CompositionBoundaryNodeBase>(Node).Visible(Props.Visible);
