...
namespace HELIX.Coloring
{
    ...
    public sealed class RadixSwatch {
        ...
        public readonly LchColor[] lightLch;
        public readonly LchColor[] darkLch;
        ...
        public RadixSwatch(string name, string[] lightHex, string[] darkHex, float bias = 1f) {
            ...
            lightLch = lightColors.Select(x => new LchColor(x.linear)).ToArray();
            darkLch = darkColors.Select(x => new LchColor(x.linear)).ToArray();
        ...
        public LchColor[] GetLch(Brightness brightness) => brightness == Brightness.Dark ? darkLch : lightLch;
        ...
        private static Color[] CalculateWeights(float hue, float chroma = 0.16f, float lumShift = 0) {
            var weights = new[] {
                ...
                new LchColor(0.95f + lumShift * 0.2f, chroma * 0.15f, hue).ToGamma(), // 100
