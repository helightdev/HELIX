...
namespace HELIX.Tests {
  public sealed class ProseWriterTests {
    ...
    public void PlainTextWriter_RendersPropertiesTreesAndFiltering() {
      ...
      writer.Name("Person");
      writer.Property("Age", 12, Datatypes.Int);
      writer.Property("Debug", "filtered", Datatypes.String, ProseLevel.Debug);
      writer.Property("Tag", (string)null, Datatypes.String, hidden: true);

      Assert.That(writer.TryBegin(ProseScopes.Tree), Is.True);
      writer.Name("Item 1");
      writer.End();
    ...
    public void BeginFrame_BalancesIgnoredFramesWhileTryBeginFrameRemainsOptIn() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Property), Is.False);

      writer.Begin(ProseScopes.Property);
      writer.Push(ProseModifiers.Strong);
      writer.Write("discarded");
      writer.Begin(ProseScopes.PropertyValue);
      writer.Write("value");
      writer.End();
      writer.End();
    ...
    public void TextWriters_HonorPropertyNameSeparatorAndDescriptionPresentation() {
      ...
      writer.Property("Named", "value", Datatypes.String, hideSeparator: true);
      writer.Property("Hidden", "standalone", Datatypes.String, hideName: true);
      writer.Property(
        "State", 42, Datatypes.Int,
      ...
      unity.Property("Named", "value", Datatypes.String, hideSeparator: true);
      unity.Property("Hidden", "standalone", Datatypes.String, hideName: true);
      unity.Property("State", 42, Datatypes.Int, description: "the answer");
    ...
    public void TextWriter_TreatsConfiguredDefaultValuesAsFine() {
      var writer = new ProseTextWriter(minimumLevel: ProseLevel.Info);
      writer.Property("Unchanged", 5, Datatypes.Int, defaultValue: 5);
      writer.Property("Changed", 6, Datatypes.Int, defaultValue: 5);
    ...
    public void DictionaryWriter_RetainsRawValueWhenTextUsesDescription() {
      ...
      writer.Property(
        "Answer", 42, ThrowingIntDatatype.Instance,
    ...
    public void PlainTextWriter_WrapsUnlessNoWrapIsActive() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Property), Is.True);
      Assert.That(writer.TryBegin(ProseScopes.PropertyKey), Is.True);
      writer.Write("Key");
      writer.End();
      Assert.That(writer.TryBegin(ProseScopes.PropertyValue), Is.True);
      ...
      writer.Reset();
      Assert.That(writer.TryBegin(ProseScopes.Property), Is.True);
      writer.Push(ProseModifiers.NoWrap);
    ...
    public void PlainTextWriter_AlignsBeforeTheValueContinuationPrefix() {
      ...
      writer.Property("Summary", "alpha beta gamma", Datatypes.String
      );
    ...
    public void PlainTextWriter_UsesConfiguredBoundariesAndRetainsAncestors() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Tree), Is.True);
      writer.Name("Parent");
      writer.Property("State", "ready", Datatypes.String);
      Assert.That(writer.TryBegin(ProseScopes.Tree), Is.True);
      writer.Name("First");
      writer.End();
      Assert.That(writer.TryBegin(ProseScopes.Tree), Is.True);
    ...
    public void PlainTextWriter_InjectsConditionalAndMandatoryPropertyContent() {
      ...
      populated.Property("A", 1, Datatypes.Int);
      populated.Property("B", 2, Datatypes.Int);
    ...
    public void PlainTextWriter_InjectsChildContentOnlyWhenChildrenExist() {
      ...
      var populated = new ProseTextWriter(configuration: configuration);
      Assert.That(populated.TryBegin(ProseScopes.Tree), Is.True);
    ...
    public void PlainTextWriter_EvaluatesCollectionStateLazilyAndPrioritiesAdditively() {
      ...
      writer.Property("A", 1, Datatypes.Int);
      writer.Property("B", 2, Datatypes.Int);
    ...
    public void PlainTextWriter_OnlyPrefixesLinesWhoseBoundaryIsEnabled() {
      ...
      Assert.That(nested.TryBegin(ProseScopes.Property), Is.True);
      nested.Write("first\nsecond");
      nested.End();
    ...
    public void PlainTextConfigurations_ShallowTerminatesTheFinalPropertyList() {
      ...
      writer.Name("Root");
      writer.Property("First", 1, Datatypes.Int);
      writer.Property("Second", 2, Datatypes.Int);
    ...
    public void PlainTextConfigurations_ShallowTerminatesWrappedProductionOutput() {
      ...
      writer.Property("Mission ID", "HX-ASTERIA-07", Datatypes.String);
      writer.Property("State", "Degraded", Datatypes.String);
      writer.Property("Crew aboard", "37 people", Datatypes.String);
      writer.Property("Orbit", "1842 completed", Datatypes.String);
      writer.Property("Autonomous control", "operational", Datatypes.String);
      writer.Property(
        "Summary",
    ...
    public void PlainTextConfigurations_KeepStructuralPresetsLimitedToTreesAndProperties() {
      foreach (var configuration in new[] {
        ...
        var writer = new ProseTextWriter(configuration: configuration);
        writer.Name("Root");
        writer.Property("Value", 1, Datatypes.Int);
        ...
        Assert.That(writer.TryBegin(ProseScopes.Section), Is.False);
        Assert.That(writer.TryBegin(ProseScopes.UnorderedList), Is.False);
        Assert.That(writer.TryBegin(ProseScopes.Table), Is.False);
    ...
    public void ErrorConfiguration_UsesItsDiagnosticPrefixOnlyForProperties() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Paragraph), Is.True);
      ...
      writer.End();
      writer.Property("Owner", "Operations", Datatypes.String);
    ...
    public void DictionaryWriter_CapturesTheDataTreeAndIgnoresFormatters() {
      var writer = new ProseDictionaryWriter();
      writer.Name("Person");
      writer.Property("Age", 12, ThrowingIntDatatype.Instance, ProseLevel.Warning);

      Assert.That(writer.TryBegin(ProseScopes.Tree), Is.True);
      writer.Name("Item");
      writer.Property("Enabled", true, Datatypes.Bool);
      writer.End();
    ...
    public void PlainTextWriter_LimitsTableColumnTargetsToTheWrapWidth() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Table), Is.True);
      Assert.That(writer.TryBegin(ProseScopes.TableHeaderRow), Is.True);
      writer.WriteTableCell("Name");
      writer.WriteTableCell("Kind");
      writer.End();
      Assert.That(writer.TryBegin(ProseScopes.TableBodyRow), Is.True);
    ...
    public void UnityRichTextWriter_DefaultConfigurationIncludesAnAsciiTree() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Tree), Is.True);
      writer.Name("Child");
      writer.Property("Child value", 2, Datatypes.Int);
      writer.End();
    ...
    public void UnityRichTextWriter_MeasuresFormattedTableCellsByVisibleText() {
      ...
      Assert.That(writer.TryBegin(ProseScopes.Table), Is.True);
      Assert.That(writer.TryBegin(ProseScopes.TableBodyRow), Is.True);
      Assert.That(writer.TryBegin(ProseScopes.TableCell), Is.True);
    ...
    public void PlainTextWriter_UsesReusableFormatterConfigurationAsAHint() {
      var writer = new ProseTextWriter();
      writer.Write(255, _hexDatatype);
      writer.Write(" ");
      writer.Write(true, _yesNoDatatype);
    ...
    public void ConfiguredFormatters_CoverDiagnosticValuePresentation() {
      var writer = new ProseTextWriter();
      writer.Write("", new StringDatatype(emptyText: "<empty>", quoted: true));
      writer.Write(" | ");
      writer.Write("value", new StringDatatype(prefix: "<", suffix: ">", quoted: true));
      writer.Write(" | ");
      writer.Write((int?)null, new IntDatatype(nullText: "missing"));
      writer.Write(" | ");
      writer.Write(12.5f, new FloatDatatype(compact: true, unit: "px"));
      writer.Write(" | ");
      writer.Write(12.5f, Datatypes.Percent);
      writer.Write(" load");
      writer.Write(" | ");
      writer.Write(1.2f, Datatypes.PercentNormalized);
      writer.Write(" normalized");
      writer.Write(" | ");
      writer.Write((bool?)null, new BoolDatatype("yes", "no", "unknown"));
      writer.Write(" | ");
      writer.Write(3, new FormattingDatatype<int>(value => "#" + value));
    ...
    public void DefaultFormatters_AreOwnedByTheCentralRegistry() {
      Assert.That(Datatypes.String, Is.SameAs(Datatypes.String));
      Assert.That(Datatypes.Int, Is.SameAs(Datatypes.Int));
      Assert.That(Datatypes.Enum<DayOfWeek>(), Is.SameAs(Datatypes.Enum<DayOfWeek>()));
      Assert.That(Datatypes.Object<object>(), Is.SameAs(Datatypes.Object<object>()));
      Assert.That(typeof(StringDatatype).GetField("Instance"), Is.Null);
      Assert.That(typeof(IntDatatype).GetField("Instance"), Is.Null);
    }
    ...
    public void ScopeExtensions_StartBuiltInScopesAndApplyTheirMetadata() {
      ...
      using (writer.Scope(ProseScopes.Table)) {
        ...
        using (writer.Scope(ProseScopes.TableCell)) {
          writer.Push(ProseModifiers.Center);
    ...
    public void Writers_FallBackToSelfFormattingProseAndCustomFormatters() {
      ...
      writer.Write(new WrappedText("fallback"), WrappedTextDatatype.Instance);
    ...
    private static string RenderConfiguration(ProseTextConfiguration configuration) {
      ...
      writer.Name("Root");
      writer.Property("Value", 1, Datatypes.Int);
      if (writer.TryBegin(ProseScopes.Tree)) {
        writer.Name("Child");
        writer.Property("Child value", 2, Datatypes.Int);
        writer.End();
      }
    ...
    private static void WriteStructuredProse(IProseWriter writer) {
      Assert.That(writer.TryBegin(ProseScopes.Section), Is.True);
      ...
      Assert.That(writer.TryBegin(new ProseList(ProseListKind.Ordered, 3)), Is.True);
      ...
      writer.WriteTableCell(3, Datatypes.Int, ProseTextAlignment.Right
      );
      writer.End();
      writer.End();
      writer.End();
    ...
    private sealed class WrappedTextDatatype : IDatatype<WrappedText> {
      public static readonly WrappedTextDatatype Instance = new();
      private WrappedTextDatatype() { }
      public void ToProse(IProseWriter writer, WrappedText value) => writer.Write(value.Value);
    }

    private static readonly IntDatatype _hexDatatype = new("X");
    private static readonly BoolDatatype _yesNoDatatype = new("yes", "no");
    private static readonly PropertyDatatype<int> _ageDatatype =
      new("Age", new IntDatatype(min: 0, max: 150, suffix: " years"));

    private sealed class ThrowingIntDatatype : IDatatype<int> {
      public static readonly ThrowingIntDatatype Instance = new();
      private ThrowingIntDatatype() { }
