...
namespace HELIX.Context {
  public static class DefaultComponentActivators {
    public static ComponentActivator MonoBehaviour<T>() where T : MonoBehaviour {
      return context => {
        ...
        } else if (Application.isPlaying) Object.DontDestroyOnLoad(obj);
        return obj.AddComponent<T>();
      };
    }

    public static ComponentActivator PlainObject<T>() where T : new() {
