...
namespace HELIX.Widgets.Elements {
  ...
  public partial class GenericSlider : BaseElement {
    ...
    [UxmlObjectReference("base-test")] public VisualElementFactory TestFactory { get; set; }
  ...
  public partial class SimpleGenericSliderTrack : GenericSliderTrackFactory {
    [UxmlAttribute] public StyleLength trackHeight = 33.Percent();

    [UxmlObjectReference("paint")] public ScriptablePaint paint = new ScriptablePainter(
  ...
  public partial class SimpleGenericSliderThumb : GenericSliderThumbFactory {
    [UxmlAttribute] public StyleLength trackHeight = Length.Auto();
