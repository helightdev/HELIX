...
namespace HELIX.Widgets.Navigation.Transitions {
  ...
  public partial class ModePageTransition : PageTransition {
    ...
    [UxmlObjectReference("Push")] public PageTransition PushTransition { get; set; }

    [UxmlObjectReference("Pop")] public PageTransition PopTransition { get; set; }

    [UxmlObjectReference("Replace")] public PageTransition ReplaceTransition { get; set; }
