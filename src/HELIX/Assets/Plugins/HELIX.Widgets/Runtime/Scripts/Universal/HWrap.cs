...
namespace HELIX.Widgets.Universal
{
    public class HWrap : MultiChildWidget {
        ...
        public override void DebugFillProperties(DiagnosticPropertiesBuilder properties) {
            ...
            properties.Add(new EnumProperty<Align>("wrapAlign", wrapAlign ?? crossAxisAlign, defaultValue: crossAxisAlign));
    ...
    public class FlexWrapElement : MultiChildWidgetBaseElement<HWrap> {
        public override void Apply(HWrap previous, HWrap widget) {
            ...
            style.flexWrap = widget.wrapReverse ? Wrap.WrapReverse : Wrap.Wrap;
