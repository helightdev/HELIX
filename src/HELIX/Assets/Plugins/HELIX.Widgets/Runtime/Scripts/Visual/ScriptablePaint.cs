...
namespace HELIX.Widgets.Visual {
  ...
  public partial class ScriptablePainter : ScriptablePaint {
    ...
    [UxmlObjectReference("builders")] public List<ScriptablePathBuilder> PathBuilders { get; set; } = new();

    [UxmlObjectReference("drawers")] public List<ScriptablePathDrawer> PathDrawers { get; set; } = new();

    [UxmlObjectReference("then")] public ScriptablePaint Then { get; set; }
