...
namespace HELIX.Compose {
  public enum CompositionRetention { Undefined = 0, Retained, Reset, New }


  public ref struct CompositionAuthoring {
    ...
    public ref ElementRef YieldElement(ref Composition ctx, VisualElement given) {
      ...
      if (cell.cursor < container.childCount) container.Insert(cell.cursor, given);
      else container.Add(given);
