...
namespace HELIX.Compose {
  ...
  public ref struct Composition {
    ...
    public static implicit operator VisualElement(Composition cx) {
      return cx.CURSOR.element;
    }
  ...
  public static class CompositionInternals {
    ...
    public static IComposable Promote(VisualElement element) {
      if (element is IComposable composable) return composable;
  ...
  public struct CompositionId {
    ...
    public static ushort GetTypeId(string name = null) {
      if (_typeIdCounter == ushort.MaxValue) throw new InvalidOperationException("TypeId counter overflow!");
