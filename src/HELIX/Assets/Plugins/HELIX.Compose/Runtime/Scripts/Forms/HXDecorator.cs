...
namespace HELIX.Compose {
  ...
  public readonly ref struct DecoratorSlots {
    ...
    public ScopeHandle Element(ref Composition cx) {
      return _element.element.Scope(ref cx);
    }

    public ScopeHandle Label(ref Composition cx) {
      return _element.label.Scope(ref cx);
    }

    public ScopeHandle Description(ref Composition cx) {
      return _element.description.Scope(ref cx);
    }

    public ScopeHandle Prefix(ref Composition cx) {
      return _element.prefix.Scope(ref cx);
    }

    public ScopeHandle Suffix(ref Composition cx) {
      return _element.suffix.Scope(ref cx);
    }

    public ScopeHandle Before(ref Composition cx) {
      return _element.before.Scope(ref cx);
    }

    public ScopeHandle Between(ref Composition cx) {
      return _element.between.Scope(ref cx);
    }

    public ScopeHandle After(ref Composition cx) {
      return _element.after.Scope(ref cx);
    }
  }
  ...
  public class HXDecorator : ComposableElement, ISlotHost {
    ...
    public void Configure(
      ...
      ConfigureSlot(
        label,
        style.decoratorPadding,
        inline ? EdgeInsets.Only(bottom: style.textGap) : EdgeInsets.Only(bottom: style.stackedGap)
      );
      ConfigureSlot(
        description,
        style.decoratorPadding,
      ...
      ConfigureSlot(suffix, style.decoratorPadding, EdgeInsets.Only(style.inlineGap));
