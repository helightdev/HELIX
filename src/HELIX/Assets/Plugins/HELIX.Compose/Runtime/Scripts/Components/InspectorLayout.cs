...
namespace HELIX.Compose {
  public readonly struct InspectorLayoutSlots {
    ...
    public InspectorLayoutSlots(
      Composable nameStart = null,
      Composable nameEnd = null,
      Composable valueStart = null,
      Composable valueEnd = null
    ) {
  ...
  public readonly struct InspectorLayout : ISpec<InspectorLayout> {
    ...
    public InspectorLayout(
      Composable name,
      Composable value,
      in InspectorLayoutSlots slots = default,
      Length? nameWidth = null,
      bool stacked = false,
      bool hideName = false
    ) {
      this.name = name;
    ...
    public ReadComposable<InspectorLayout> GetDefault(in InspectorLayout spec) {
      return Default;
    }
    ...
    public static void Default(ref Composition cx, in InspectorLayout spec) {
      ...
      using (cx.Row(cross: Align.Center)) {
        ...
        ComposeValue(ref cx, spec, false);
      }
    }
