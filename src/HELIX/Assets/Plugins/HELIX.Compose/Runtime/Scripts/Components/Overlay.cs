...
namespace HELIX.Compose {
  ...
  [Mixable, Structure] public readonly partial struct OverlayOptions {
    ...
    public bool Has(OverlayBehavior value) {
  ...
  public readonly struct OverlayContextData : IEquatable<OverlayContextData> {
    ...
    public bool Dismiss(OverlayDismissReason reason = OverlayDismissReason.Manual) {
      return handle?.Dismiss(reason) ?? false;
    }

    public bool Equals(OverlayContextData other) {
      return ReferenceEquals(controller, other.controller) && ReferenceEquals(handle, other.handle);
    }

    public override bool Equals(object obj) {
      return obj is OverlayContextData other && Equals(other);
    }

    public override int GetHashCode() {
      return HashCode.Combine(controller, handle);
    }
  }
  ...
  public sealed class OverlayHandle {
    ...
    public bool Dismiss(OverlayDismissReason reason = OverlayDismissReason.Manual) {
      return Controller?.Dismiss(Id, reason) ?? false;
    }

    public bool Replace(Composable<OverlayContextData> content) {
      return Controller?.Replace(Id, content) ?? false;
    }
  }
  ...
  public sealed class OverlayBuilder {
    ...
    public OverlayBuilder FollowAnchor(bool enabled = true) {
      return Set(OverlayBehavior.FollowAnchor, enabled);
    }

    public OverlayBuilder MatchAnchorWidth(bool enabled = true) {
      return Set(OverlayBehavior.MatchAnchorWidth, enabled);
    }

    public OverlayBuilder FlipToFit(bool enabled = true) {
      return Set(OverlayBehavior.FlipToFit, enabled);
    }
    ...
    public OverlayBuilder DismissOnOutsidePointer(bool enabled = true) {
      return Set(OverlayBehavior.DismissOnOutsidePointer, enabled);
    }

    public OverlayBuilder DismissOnCancel(bool enabled = true) {
      return Set(OverlayBehavior.DismissOnCancel, enabled);
    }

    public OverlayBuilder DismissWhenAnchorDetaches(bool enabled = true) {
      return Set(OverlayBehavior.DismissWhenAnchorDetached, enabled);
    }
    ...
    public OverlayBuilder Prelayout(bool enabled = true) {
      return Set(OverlayBehavior.Prelayout, enabled);
    }
    ...
    public OverlayHandle Show(CompositionContext context) {
      return Show(context.Overlays(), context.boundary);
    }
    ...
    private OverlayOptions BuildOptions() {
  ...
  public static class Overlay {
    public static OverlayBuilder Build(Composable<OverlayContextData> content) {
      return new OverlayBuilder(content);
    }
    ...
    public static OverlayBuilder Build(
      ...
      return new OverlayBuilder(content, in options);
    }
  }
  ...
  public sealed class OverlayController : Signal<int> {
    ...
    public OverlayHandle Show(
      ...
      if (resolvedOptions.onDismissed != null && callbackBoundary == null) {
        throw new ArgumentNullException(
          nameof(callbackBoundary),
          "A dismissal action requires the boundary that owns its composition context."
        );
      }
    ...
    public bool DismissTop(OverlayDismissReason reason = OverlayDismissReason.Manual) {
      return Top != null && Dismiss(Top.Id, reason);
    }
  ...
  public static class OverlayExtensions {
    ...
    public static OverlayController Overlays(this CompositionContext context) {
      return OverlayContextData.Key.ReadAt(context.element).controller ??
    ...
    public static OverlayHandle OverlayEntry(this ref Composition cx, bool listen = true) {
      return cx.ReadContext(OverlayContextData.Key, listen).handle;
    }

    public static OverlayHandle OverlayEntry(this CompositionContext context) {
      return OverlayContextData.Key.ReadAt(context.element).handle ??
