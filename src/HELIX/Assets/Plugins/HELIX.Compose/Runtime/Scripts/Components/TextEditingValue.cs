...
namespace HELIX.Compose {
  public struct TextEditingValue : IEquatable<TextEditingValue> {
    ...
    public static implicit operator TextEditingValue(string text) {
      return new TextEditingValue(text);
    }

    public static implicit operator string(TextEditingValue value) {
      return value.text;
    }
    ...
    public TextEditingValue SelectToStart() {
      return SelectTo(0);
    }
    ...
    public readonly override bool Equals(object obj) {
      return obj is TextEditingValue other && Equals(other);
    }

    public readonly override int GetHashCode() {
      return HashCode.Combine(text, cursorIndex, selectionIndex);
    }

    public readonly override string ToString() {
      return $"{text} [{cursorIndex}-{selectionIndex}]";
    }
    ...
    public readonly string ToFormattedString() {
      ...
      } else builder = builder.Insert(cursorIndex, "^");
  ...
  public readonly struct TextEditResult {
    ...
    public static TextEditResult Continue(bool interrupt = false) {
      return new TextEditResult(interrupt, false, TextEditEndReason.None);
    }

    public static TextEditResult Break(bool interrupt = true) {
      return new TextEditResult(interrupt, true, TextEditEndReason.None);
    }
