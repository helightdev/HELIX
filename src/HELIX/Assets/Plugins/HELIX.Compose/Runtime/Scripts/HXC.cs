...
namespace HELIX {
  ...
  public static class HXProfiling {
    ...
    [Conditional("ENABLE_PROFILER")]
    public static void TrackComposableReset(int count = 1) => _composableResets.Value += count;
