 ...
 */
class HelixMixinFindUsagesProvider : FindUsagesProvider {
    override fun getWordsScanner(): WordsScanner = SimpleWordsScanner()

    override fun canFindUsagesFor(psiElement: PsiElement): Boolean =
        psiElement is HelixMixinDeclarationElement

    override fun getHelpId(psiElement: PsiElement): String? = null

    override fun getType(element: PsiElement): String =
        if (element is HelixMixinDeclarationElement) "mixin declaration" else "mixin symbol"

    override fun getDescriptiveName(element: PsiElement): String =
        (element as? HelixMixinDeclarationElement)?.name ?: element.text
