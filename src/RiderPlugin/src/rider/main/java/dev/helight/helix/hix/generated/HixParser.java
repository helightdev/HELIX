...
public class HixParser extends Parser {
	...
	public final CompilationUnitContext compilationUnit() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 123150812577792L) != 0)) {
				{
				setState(129);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final MixinBodyContext mixinBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 263885616578560L) != 0)) {
				{
				setState(150);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public static class TableSignatureEntryContext extends ParserRuleContext {
		public List<TerminalNode> ROOT_IDENTIFIER() { return getTokens(HixParser.ROOT_IDENTIFIER); }
	...
	public final StatementBlockContext statementBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 294651985658880L) != 0)) {
				{
				setState(222);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final WhenChainBodyContext whenChainBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 13510798889451536L) != 0)) {
				{
				setState(288);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final WhenValueStatementContext whenValueStatement() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2251799813808656L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 2051L) != 0)) {
				{
				setState(302);
				value();
				}
	...
	public final WhenValueBodyContext whenValueBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 2251799821148688L) != 0) || ((((_la - 67)) & ~0x3f) == 0 && ((1L << (_la - 67)) & 2051L) != 0)) {
				{
				setState(319);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final ControlflowStatementContext controlflowStatement() throws RecognitionException {
		...
		try {
			...
			case KEYWORD_RETURN:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 13510798882111504L) != 0)) {
					{
					setState(351);
					valueList();
					}
	...
	public final ContentBodyContext contentBody() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 504403158265495808L) != 0) );
			}
		}
		catch (RecognitionException re) {
			_localctx.exception = re;
	...
	public final ArgumentBodyContext argumentBody() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18014398509482504L) != 0)) {
				{
				setState(488);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
