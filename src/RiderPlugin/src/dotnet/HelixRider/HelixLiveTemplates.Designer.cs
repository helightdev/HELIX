...
namespace HelixRider
{
  ...
  public static class HelixLiveTemplates
  {
    private static readonly ILogger ourLog = Logger.GetLogger("HelixRider.HelixLiveTemplates");

    static HelixLiveTemplates()
    {
      CultureContextComponent.Instance.Change.Advise(Lifetime.Eternal, args =>
      {
          ...
          if (instance != null)
          {
            ourResourceManager = new Lazy<JetResourceManager>(
              ...
              {
                return instance
                  .CreateResourceManager("HelixRider.HelixLiveTemplates", typeof(HelixLiveTemplates).Assembly);
              });
          }
          else
          {
