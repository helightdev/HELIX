...
description: Install HELIX Widgets, mount your first widget tree, and learn the essential building blocks.
---
...
## Building with collection initializers
...
### Conditional and projected children
